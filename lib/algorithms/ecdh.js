...
var ecdh = module.exports = {
  addNodeJsECCurveNameMapping:function(key,value){
    NodeJsECCurveNameMapping[key]=value;
  }
};
var NodeJsECCurveNameMapping = {
  "P-256":"prime256v1",
  "P-384":"secp384r1",
  "P-521":"secp521r1"
}
...
function ecdhDeriveFn() {
  ...
  var nodejs = function(key, props) {
    ...
    props = props || {};
    var keyLen = props.length || 0;
    var curve = NodeJsECCurveNameMapping[key.crv];
    if(curve===undefined)
