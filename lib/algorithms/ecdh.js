...
var NODE_CURVE_MAPPING = {
  "P-256":"prime256v1",
  "P-384":"secp384r1",
  "P-521":"secp521r1"
}

pluggedData.NODE_CURVE_MAPPING.forEach(function(mapping){
  NODE_CURVE_MAPPING[mapping.curve]=mapping.nodejsCurve;
})
...
function ecdhDeriveFn() {
  ...
  var nodejs = function(key, props) {
    ...
    props = props || {};
    var keyLen = props.length || 0;
    var curve = NODE_CURVE_MAPPING[key.crv];
    if(curve===undefined)
      return Promise.reject(new Error("invalid curve: " + key.crv));
