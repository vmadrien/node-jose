...
var BigInteger = require("../../deps/forge").jsbn.BigInteger,
    ec = require("./math.js"),
    pluggedData = require('../../plugin/customECPlug');
...
function getX9ECParameters(p,a,b,n,h,gLeft,gRight){
  var curve = new ec.ECCurveFp(fromHex(p), fromHex(a), fromHex(b));
  var G = curve.decodePointHex("04"+gLeft+gRight);
  return new X9ECParameters(curve, G, fromHex(n), fromHex(h));
}
...
var CURVES = module.exports = {
  ...
  addCurve : function(curve){
    this[curve.curveName] = getX9ECParameters(curve.p,curve.a,curve.b,curve.n,curve.h,curve.gLeft,curve.gRight); 
  }
};
